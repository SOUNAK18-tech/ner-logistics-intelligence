...
import { api, auth, alertsAPI, ensureToken, BASE_URL } from '../services/api';
      ...
      <div style={{
        ...
        <div style={{ padding: '20px 24px' }}>
          ...
          {!isML && (
            <>
              {alert.photoUrl && (
                <img src={assetUrl(alert.photoUrl)} alt="Scene" style={{ width: '100%', maxHeight: 200, objectFit: 'cover', borderRadius: 10, marginBottom: 12, border: '1px solid var(--line)' }} />
              )}
